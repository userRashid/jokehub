(function () {
    ...
    angular
        ...
        .controller('ApprovedJokeController', _ApprovedJokeController);

    _ApprovedJokeController.$inject = ['JokeService', '$sce', 'CategoryService', 'RejectReason', 'AdministratorService', 'NgTableParams'];

    function _ApprovedJokeController(JokeService, $sce, CategoryService, RejectReason, AdministratorService, NgTableParams) {
