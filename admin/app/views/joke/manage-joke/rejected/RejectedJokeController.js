(function () {
    ...
    angular
        ...
        .controller('RejectedJokeController', _RejectedJokeController);

    _RejectedJokeController.$inject = ['JokeService', '$sce', 'CategoryService', 'RejectReason', 'AdministratorService', 'NgTableParams'];

    function _RejectedJokeController(JokeService, $sce, CategoryService, RejectReason, AdministratorService, NgTableParams) {
